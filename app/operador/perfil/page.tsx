    ...
    <div className="px-16 py-14">
      ...
      {loading ? (
        <div className="space-y-4 max-w-2xl">
          <Skeleton className="h-32 rounded-[14px] bg-surface" />
          <Skeleton className="h-48 rounded-[14px] bg-surface" />
        </div>
      ) : !profile ? (
          ...
          <div className="bg-surface border border-line rounded-[14px] p-6">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-14 h-14 bg-[#7C1EFB]/[0.16] border border-[#7C1EFB]/40 rounded-2xl flex items-center justify-center">
                <User size={24} className="text-brand-soft" />
              </div>
              <div>
              ...
              <span className={`ml-auto inline-block rounded-full px-3.5 py-1.5 text-[13px] font-bold ${profile.active ? "bg-[#5B21F0]/[0.22] text-brand-soft" : "bg-surface-hover border border-line text-dim"}`}>
              ...
              {tenure && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-dim text-xs">{tenure.days} dias no total</p>
                  </div>
                </div>
              )}
          ...
          {tenure && (
            <div className="bg-[#5B21F0]/10 border border-[#5B21F0]/20 rounded-[14px] p-5 flex items-center gap-4">
              <div className="w-12 h-12 bg-[#7C1EFB]/[0.16] rounded-xl flex items-center justify-center">
                <Clock size={20} className="text-brand-soft" />
              </div>
              <div>
                <p className="text-ink font-bold text-lg">{tenure.label} na ROI Tracker</p>
                <p className="text-dim text-sm">
