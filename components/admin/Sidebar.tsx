...
import { LayoutDashboard, Users, UserCheck, LogOut, ChevronRight } from "lucide-react";
      ...
      <div className="p-6 border-b border-[#1A2140]">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-[#1440FF] rounded-lg flex items-center justify-center">
            <span className="text-white font-bold font-titillium text-xs">N</span>
          </div>
          <div>
            <p className="text-white font-bold font-titillium text-sm leading-tight">NitroADS</p>
            <p className="text-[#8892A4] text-xs font-manrope leading-tight">Torre de Comando</p>
          </div>
        </div>
      </div>
